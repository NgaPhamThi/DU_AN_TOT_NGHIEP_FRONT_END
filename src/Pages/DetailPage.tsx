...
const DetailPage = () => {
    return (
        <div className='mx-[50px] mt-[50px]'>
            <div className="product_detail_row_1 flex gap-[50px]">
                <div className="row_1_column_1 flex gap-[40px]">
                    <div className="image_detail_product_1">
                        <ul>
                            <a href=""><img className='np-image-product-detail-small' src="https://lzd-img-global.slatic.net/g/p/c8717c31871ccc892aff7111a20b01c5.jpg_720x720q80.jpg" alt="" /></a>
                            <a href=""><img className='np-image-product-detail-small' src="https://lzd-img-global.slatic.net/g/p/c8717c31871ccc892aff7111a20b01c5.jpg_720x720q80.jpg" alt="" /></a>
                            <a href=""><img className='np-image-product-detail-small' src="https://lzd-img-global.slatic.net/g/p/c8717c31871ccc892aff7111a20b01c5.jpg_720x720q80.jpg" alt="" /></a>
                            <a href=""><img className='np-image-product-detail-small' src="https://lzd-img-global.slatic.net/g/p/c8717c31871ccc892aff7111a20b01c5.jpg_720x720q80.jpg" alt="" /></a>
                        </ul>
                ...
                <div className="row_1_column_2">
                    ...
                    <div className="row_id_sale flex gap-[40px] mt-[10px] items-center">
                        ...
                        <div className="flex gap-[50px]">
                            <div className="px-[10px] py-[5px] bg-blue-300 text-center">
                                <span className='text-[14px]'>Giảm 3k</span>
                            </div>
                            <div className="px-[10px] py-[5px] bg-blue-300">
                    ...
                    <div className="row_color">
                        ...
                        <div className="product_size">
                            <div className="color_product flex gap-[30px] mt-[20px]">
                                <div className="np-color-product bg-slate-700"> </div>
                                <div className="np-color-product bg-red-400"></div>
                                <div className="np-color-product bg-blue-500"></div>
                            </div>
                            <div className="size pt-[20px] flex justify-between">
                                <div className="size_product flex gap-[30px]">
                                    <div className="np_size_product">
                                        <span>S</span>
                                    </div>
                                    <div className="np_size_product">
                                        <span>M</span>
                    ...
                    <div className="row_quantity flex gap-[40px] mt-[20px]">
                        ...
                        <div className="quantity mt-[10px]">
                            <form action="" className='flex'>
                                <div className="w-[40px] bg-slate-300 text-center"> <span>+</span></div>
                                <input className='w-[60px] bg-slate-500' type="text" />
                                <div className="w-[40px] h-[30px] bg-slate-300 text-center pb-[15px]">  <span>_</span></div>

                            </form>
                        </div>
                    </div>
                    <div className="cart mt-[20px] flex gap-[30px]">
                        <div className="flex gap-[30px] w-[240px] h-[40px] bg-red-300 items-center border rounded-md">
                        ...
                        <div className="pt-[5px] w-[240px] h-[40px] bg-red-600 items-center text-center border rounded-md items-center">
            ...
            <div className="product_detail_row_2 flex gap-[50px] my-[50px]">
                <div className="describe_product basis-5/6">
                    <div className="describe_product_row">
                        <div className="title_describe bg-slate-400 h-[40px]">
                    ...
                    <div className="describe_product_row mt-[30px]">
                        ...
                        <div className="content_describe flex mt-[30px] bg-slate-400 h-[130px] pl-[50px]">
                    ...
                    <div className="row_comment mt-[30px] pl-[40px] mb-[30px]">
                        ...
                        <div className="row_comment_4 flex gap-[30px] mt-[30px]">
                            <img className='np_image_comment' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_8bvIuqKf78T_K_OuUiNkFInsv7OIqyPmyVzVG9YBsBKt6Hs8A_MO6NNMbXLCSvHuZvo&usqp=CAU" alt="" />
                            <img className='np_image_comment' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_8bvIuqKf78T_K_OuUiNkFInsv7OIqyPmyVzVG9YBsBKt6Hs8A_MO6NNMbXLCSvHuZvo&usqp=CAU" alt="" />
                            <img className='np_image_comment' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_8bvIuqKf78T_K_OuUiNkFInsv7OIqyPmyVzVG9YBsBKt6Hs8A_MO6NNMbXLCSvHuZvo&usqp=CAU" alt="" />
                            <img className='np_image_comment' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_8bvIuqKf78T_K_OuUiNkFInsv7OIqyPmyVzVG9YBsBKt6Hs8A_MO6NNMbXLCSvHuZvo&usqp=CAU" alt="" />
                            <img className='np_image_comment' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_8bvIuqKf78T_K_OuUiNkFInsv7OIqyPmyVzVG9YBsBKt6Hs8A_MO6NNMbXLCSvHuZvo&usqp=CAU" alt="" />
                    ...
                    <div className="row_product_new mt-[20px] ">
                        ...
                        <div className="row_product_new_main flex gap-[30px]">
                            <div className="">
                                <div className="image">
                ...
                <div className="Products_abs basis-1/6">
